<template>
  <div class="min-h-screen flex items-center justify-center bg-[var(--win-bg-base)] relative overflow-hidden">
    ...
    <div class="w-full max-w-md z-10 animate-fade-in-up px-6">
      ...
      <div class="glass-panel p-8 md:p-10 !rounded-3xl !border-white/10">
        ...
        <div class="flex flex-col items-center mb-8">
          <div class="relative mb-6">
            ...
            <!-- Logo -->
            <div class="relative w-40 h-40 rounded-3xl bg-gradient-to-br from-[var(--glass-level-3-bg)] to-[var(--glass-level-1-bg)] flex items-center justify-center border border-white/10 shadow-2xl p-6">
          ...
          <div class="flex items-center gap-2 mb-8">
            <span class="font-semibold text-[var(--win-text-primary)]">Copy<span class="text-[var(--brand-1)]">Cat</span></span>
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div class="relative group">
            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              <UIcon name="i-heroicons-user" class="w-5 h-5 text-[var(--win-text-muted)] group-focus-within:text-[var(--win-accent)] transition-colors" />
            </div>
            <input
              id="username"
              v-model="username"
        ...
        <div class="text-center mt-8 pt-6 border-t border-white/5">
           <a href="#" class="text-xs text-[var(--win-text-muted)] hover:text-[var(--win-accent)] transition-colors inline-flex items-center gap-1">
      ...
      <!-- Version Badge -->
      <div class="text-center mt-6 text-xs text-[var(--win-text-secondary)]">
